...
<p class="pull-right"><input type="button" value="Pauza" id="butonPauza" onclick="pauza()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input>
    <input type="button" value="Continua" id="butonContinua" onclick="continua()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input></p>
</div>
</div>
<div class="panel panel-default">
<div class="panel-heading"  style = "background-color: #ffe6cc">
...
<p class="pull-right"><input type="button" value="Pauza" id="butonPauza2" onclick="pauza2()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input>
    <input type="button" value="Continua" id="butonContinua2" onclick="continua2()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input></p>
</div>
</div>
...
<iframe id="framerosu" class="embed-responsive-item" width="240" height= "450" src="led.html" frame-border = "0" allowfullscreen=""></iframe><br>
  ...
  <input type="button" value="Pauza" id="butonPauza" onclick="pauzaleduri()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input>
  <input type="button" value="Continua" id="butonContinua" onclick="continualeduri()" class="butoncss btn btn-default" style = "background-color: #FFF3E6"></input>
  </center>
